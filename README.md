...
* _Always_: 2FA is always required for any registered user account, and it's enforced on EU Login, which will allow to choose only compatible authentication methods.
